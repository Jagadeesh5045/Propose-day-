...
function drawText() {
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      ...
      context.fillText(
        "I love you so much , more than all the time and space in the universe can contain bujjamma",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 3300 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      ...
      context.fillText(
        "and I can't wait to spend all the time in the world to share that love with you kannamma!",
        canvas.width / 2,
        canvas.height / 2 + 50
      );
    }
